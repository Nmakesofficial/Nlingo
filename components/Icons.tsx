...
export const TextBubbleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const WaveformIcon: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 37 28" className={className}>
    <rect width="3" height="12" x="0" y="8" rx="1.5" />
    <rect width="3" height="28" x="6" y="0" rx="1.5" />
    <rect width="3" height="18" x="12" y="5" rx="1.5" />
    <rect width="3" height="12" x="18" y="8" rx="1.5" />
    <rect width="3" height="23" x="24" y="2.5" rx="1.5" />
    <rect width="3" height="12" x="30" y="8" rx="1.5" />
    <rect width="3" height="18" x="36" y="5" rx="1.5" />
  </svg>
);
